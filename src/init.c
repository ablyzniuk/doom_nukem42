...
/*   Updated: 2019/05/07 20:14:16 by ablizniu         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
//
//	// набор точек
//	vertex = (t_vertex*)ft_memalloc(sizeof(t_vertex) * 8);
//	// сектор
//	sector = (t_sector**)ft_memalloc(sizeof(t_sector*) * 5);
//	sector[0] = (t_sector*)ft_memalloc(sizeof(t_sector));
//	sector[1] = (t_sector*)ft_memalloc(sizeof(t_sector));
//	sector[2] = (t_sector*)ft_memalloc(sizeof(t_sector));
//	sector[3] = (t_sector*)ft_memalloc(sizeof(t_sector));
//	sector[4] = (t_sector*)ft_memalloc(sizeof(t_sector));
//	// набоh точек сектора
//	sector[0]->typewall = (int*)ft_memalloc(sizeof(int) * 4);
...
//
//	sector[0]->vertex = (int*)ft_memalloc(sizeof(int) * 5);
//	sector[0]->vertex[0] = 0;
//	sector[0]->vertex[1] = 1;
//	sector[0]->vertex[2] = 5;
//	sector[0]->vertex[3] = 4;
//
//
//	sector[1]->typewall = (int*)ft_memalloc(sizeof(int) * 4);
...
//
//	sector[1]->vertex = (int*)ft_memalloc(sizeof(int) * 5);
//	sector[1]->vertex[0] = 1;
//	sector[1]->vertex[1] = 2;
//	sector[1]->vertex[2] = 6;
//	sector[1]->vertex[3] = 5;
...
//
//	sector[2]->typewall = (int*)ft_memalloc(sizeof(int) * 4);
//	sector[2]->typewall[0] = 1;
//	sector[2]->typewall[1] = 4;
//	sector[2]->typewall[2] = 3;
//	sector[2]->typewall[3] = -1;
//
//	sector[2]->vertex = (int*)ft_memalloc(sizeof(int) * 5);
//	sector[2]->vertex[0] = 2;
//	sector[2]->vertex[1] = 6;
//	sector[2]->vertex[2] = 7;
//	sector[2]->vertex[3] = 3;
...
//
//	sector[3]->typewall = (int*)ft_memalloc(sizeof(int) * 4);
...
//
//	sector[3]->vertex = (int*)ft_memalloc(sizeof(int) * 5);
//	sector[3]->vertex[0] = 7;
//	sector[3]->vertex[1] = 3;
//	sector[3]->vertex[2] = 0;
//	sector[3]->vertex[3] = 4;
...
//
//	sector[4]->typewall = (int*)ft_memalloc(sizeof(int) * 4);
...
//
//	sector[4]->vertex = (int*)ft_memalloc(sizeof(int) * 5);
//	sector[4]->vertex[0] = 4;
//	sector[4]->vertex[1] = 5;
//	sector[4]->vertex[2] = 6;
//	sector[4]->vertex[3] = 7;
