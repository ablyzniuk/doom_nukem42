...
void	ft_init(t_main *m)
{
	...
	sector[2]->heigth.z = 2000;
	sector[2]->vertex[0] = 2;
	sector[2]->vertex[1] = 6;
	sector[2]->vertex[2] = 7;
	sector[2]->vertex[3] = 3;
	sector[2]->heigth.max_he = 20;
	sector[2]->heigth.min_he = 0;
	...
	sector[3]->heigth.z = 2000;
	sector[3]->vertex[0] = 7;
	sector[3]->vertex[1] = 3;
	sector[3]->vertex[2] = 0;
	sector[3]->vertex[3] = 4;
	sector[3]->heigth.max_he = 20;
	sector[3]->heigth.min_he = 0;

	sector[4]->typewall = (int*)malloc(sizeof(int) * 4);
	sector[4]->typewall[0] = -1;
	sector[4]->typewall[1] = -1;
	sector[4]->typewall[2] = -1;
	sector[4]->typewall[3] = -1;

	sector[4]->vertex = (int*)malloc(sizeof(int) * 5);
	sector[4]->heigth.z = 500;
	sector[4]->vertex[0] = 4;
	sector[4]->vertex[1] = 5;
	sector[4]->vertex[2] = 6;
	sector[4]->vertex[3] = 7;
	sector[4]->heigth.max_he = 20;
	sector[4]->heigth.min_he = 0;
