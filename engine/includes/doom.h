...
/*   Updated: 2019/06/27 17:32:49 by ablizniu         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void				ft_drawscreen_0(int32_t *border_b_h, int32_t *border_t_h,
					t_heigth_wall wall);
t_draw_save			ft_drawscreen_1(t_main *m, t_ray ray, t_heigth_wall *wall,
					t_buffer *buffer);
...
void				ft_get_border_top(t_main *m, t_ray ray,
					t_heigth_wall *wall);
...
void				ft_get_wall_heigth(t_main *m, t_ray ray,
					t_heigth_wall *wall);
...
double				**parse_vertex_params(char *data, t_main *main,
					size_t *len);

int32_t				*parse_transit_pair(char **data, size_t size);

int32_t				*parse_transit_parameters(char *data,
					size_t vertex_array_len);
...
void				ft_draw_floor(t_main *m, t_ray ray,
							t_heigth_wall wall, t_buffer *buf);
t_rgb				ft_get_pixel_wall(t_main *m, t_heigth_wall wall, t_ray ray,
					int32_t *data_arr);
